        ...
        <div className="auth-side-panel">
            <div className="side-panel-content">
                ...
                <p className="side-panel-subtitle">
                    {subtitle || "Create a stunning portfolio in minutes and get discovered by top recruiters."}
                </p>

                {image ? (
                    <div className="side-panel-image-container" style={{ marginTop: '2rem', display: 'flex', justifyContent: 'center' }}>
                        <img src={image} alt="Authentication Visual" style={{ maxWidth: '80%', height: 'auto', maxHeight: '280px' }} />
                    </div>
                ) : (
                ...
                <div className="side-panel-badges">
                    <span className="side-panel-badge">✦ AI-Powered</span>
                    <span className="side-panel-badge">⚡ 2,400+ Users</span>
                    <span className="side-panel-badge">🔒 Secure</span>
                </div>
            </div>
